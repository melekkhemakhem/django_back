...
async function requestApi(pathname, init, commandOptions) {
  ...
  const apiResponse = await _asyncretry2.default.call(void 0, 
    async (bail) => {
      let res;
      try {
        res = await _undici.fetch.call(void 0, getApiUrl(pathname), {
          ...init,
          headers: {
